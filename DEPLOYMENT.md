...
Images and videos are served from R2 bucket **`bkdziti-assets`**.  
...
```json
"r2_buckets": [
  { "binding": "MEDIA", "bucket_name": "bkdziti-assets" }
]
```

In **Cloudflare Pages → your project → Settings → Functions**:
- Under **R2 bucket bindings**, add binding `MEDIA` → bucket `bkdziti-assets`
...
npx wrangler r2 object put bkdziti-assets/Datamosh-Dream.webm   --file "assets/images/Datamosh-Dream.webm"   --content-type video/webm
npx wrangler r2 object put bkdziti-assets/Datamosh-Dream1.webm  --file "assets/images/Datamosh-Dream1.webm"  --content-type video/webm
npx wrangler r2 object put bkdziti-assets/EatMyBallsAdCompressed.webm --file "assets/images/EatMyBallsAdCompressed.webm" --content-type video/webm
npx wrangler r2 object put bkdziti-assets/bkdziti_intro.webm    --file "assets/images/bkdziti_intro.webm"    --content-type video/webm
npx wrangler r2 object put bkdziti-assets/food2.webm            --file "assets/images/food2.webm"            --content-type video/webm
npx wrangler r2 object put bkdziti-assets/store.webm            --file "assets/images/store.webm"            --content-type video/webm
npx wrangler r2 object put bkdziti-assets/store0.webm           --file "assets/images/store0.webm"           --content-type video/webm
npx wrangler r2 object put bkdziti-assets/store1.webm           --file "assets/images/store1.webm"           --content-type video/webm
npx wrangler r2 object put bkdziti-assets/ziti.webm             --file "assets/images/ziti.webm"             --content-type video/webm
npx wrangler r2 object put bkdziti-assets/MP4-converted.webm    --file "assets/images/MP4-converted.webm"    --content-type video/webm

# ── Photos / large images ─────────────────────────────────────────────────
npx wrangler r2 object put bkdziti-assets/BKDziti_pfp_2.PNG     --file "assets/images/BKDziti_pfp_2.PNG"     --content-type image/png
npx wrangler r2 object put bkdziti-assets/EatMyBalls2.PNG       --file "assets/images/EatMyBalls2.PNG"       --content-type image/png
npx wrangler r2 object put bkdziti-assets/IMG_0326.JPG          --file "assets/images/IMG_0326.JPG"          --content-type image/jpeg
npx wrangler r2 object put bkdziti-assets/IMG_1123.PNG          --file "assets/images/IMG_1123.PNG"          --content-type image/png
npx wrangler r2 object put bkdziti-assets/IMG_2336.JPG          --file "assets/images/IMG_2336.JPG"          --content-type image/jpeg
npx wrangler r2 object put "bkdziti-assets/IMG_2339(1).JPG"     --file "assets/images/IMG_2339(1).JPG"       --content-type image/jpeg
npx wrangler r2 object put "bkdziti-assets/IMG_2340(1).JPG"     --file "assets/images/IMG_2340(1).JPG"       --content-type image/jpeg
npx wrangler r2 object put bkdziti-assets/IMG_2456.JPG          --file "assets/images/IMG_2456.JPG"          --content-type image/jpeg

# ── Other images (also uploaded so R2 serves them with immutable caching) ─
npx wrangler r2 object put bkdziti-assets/BKDziti_Logo_Transparent.png --file "assets/images/BKDziti_Logo_Transparent.png" --content-type image/png
npx wrangler r2 object put bkdziti-assets/EatMyBalls.png        --file "assets/images/EatMyBalls.png"        --content-type image/png
npx wrangler r2 object put bkdziti-assets/IMG_8386-0_downscaled.png --file "assets/images/IMG_8386-0_downscaled.png" --content-type image/png
npx wrangler r2 object put bkdziti-assets/IMG_1633.png          --file "assets/images/IMG_1633.png"          --content-type image/png
npx wrangler r2 object put bkdziti-assets/image0.jpeg           --file "assets/images/image0.jpeg"           --content-type image/jpeg
npx wrangler r2 object put bkdziti-assets/card.png              --file "assets/images/card.png"              --content-type image/png
npx wrangler r2 object put "bkdziti-assets/BKDziti Business Card.png" --file "assets/images/BKDziti Business Card.png" --content-type image/png
npx wrangler r2 object put bkdziti-assets/BKDzitiBusinessCard.png --file "assets/images/BKDzitiBusinessCard.png" --content-type image/png
npx wrangler r2 object put bkdziti-assets/favicon.svg           --file "assets/images/favicon.svg"           --content-type image/svg+xml
npx wrangler r2 object put bkdziti-assets/favicon.ico           --file "assets/images/favicon.ico"           --content-type image/x-icon
npx wrangler r2 object put bkdziti-assets/favicon-16x16.png     --file "assets/images/favicon-16x16.png"     --content-type image/png
npx wrangler r2 object put bkdziti-assets/favicon-32x32.png     --file "assets/images/favicon-32x32.png"     --content-type image/png
npx wrangler r2 object put bkdziti-assets/favicon-96x96.png     --file "assets/images/favicon-96x96.png"     --content-type image/png
npx wrangler r2 object put bkdziti-assets/favicon-128.png       --file "assets/images/favicon-128.png"       --content-type image/png
npx wrangler r2 object put bkdziti-assets/favicon-196x196.png   --file "assets/images/favicon-196x196.png"   --content-type image/png
npx wrangler r2 object put bkdziti-assets/apple-touch-icon.png  --file "assets/images/apple-touch-icon.png"  --content-type image/png
npx wrangler r2 object put bkdziti-assets/android-chrome-192x192.png --file "assets/images/android-chrome-192x192.png" --content-type image/png
npx wrangler r2 object put bkdziti-assets/android-chrome-512x512.png --file "assets/images/android-chrome-512x512.png" --content-type image/png
npx wrangler r2 object put bkdziti-assets/web-app-manifest-192x192.png --file "assets/images/web-app-manifest-192x192.png" --content-type image/png
npx wrangler r2 object put bkdziti-assets/web-app-manifest-512x512.png --file "assets/images/web-app-manifest-512x512.png" --content-type image/png
npx wrangler r2 object put bkdziti-assets/site.webmanifest      --file "assets/images/site.webmanifest"      --content-type application/manifest+json

# ── PDFs ──────────────────────────────────────────────────────────────────
npx wrangler r2 object put bkdziti-assets/AZ_resume.pdf         --file "assets/images/AZ_resume.pdf"         --content-type application/pdf
npx wrangler r2 object put "bkdziti-assets/Cover Letter Generic Redux.pdf" --file "assets/images/Cover Letter Generic Redux.pdf" --content-type application/pdf
```
...
npx wrangler r2 object list bkdziti-assets
```
